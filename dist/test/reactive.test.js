...
const reactive_1114_1 = require("../src/practice/reactive/reactive-1114");
(0, globals_1.describe)('reactive', () => {
    (0, globals_1.test)('should track and trigger effects', () => {
        const obj = (0, reactive_1114_1.reactive)({ count: 0 });
        let dummy;
        (0, reactive_1114_1.effect)(() => {
            dummy = obj.count;
        });
    ...
    (0, globals_1.test)('should handle multiple properties', () => {
        const obj = (0, reactive_1114_1.reactive)({ count: 0, name: 'test' });
    ...
    (0, globals_1.test)('should handle nested reactivity', () => {
        const obj = (0, reactive_1114_1.reactive)({ nested: { count: 0 } });
        let dummy;
        (0, reactive_1114_1.effect)(() => {
