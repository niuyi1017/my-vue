...
const deepCopy_1023_1 = require("../src/practice/deepCopy/deepCopy-1023");
const globals_1 = require("@jest/globals");
(0, globals_1.describe)('deepCopy', () => {
    (0, globals_1.test)('should return null if input is null', () => {
        (0, globals_1.expect)((0, deepCopy_1023_1.deepCopy)(null)).toBeNull();
    });
    (0, globals_1.test)('should return the same primitive value if input is a primitive', () => {
        (0, globals_1.expect)((0, deepCopy_1023_1.deepCopy)(42)).toBe(42);
        (0, globals_1.expect)((0, deepCopy_1023_1.deepCopy)('hello')).toBe('hello');
        (0, globals_1.expect)((0, deepCopy_1023_1.deepCopy)(true)).toBe(true);
    });
    (0, globals_1.test)('should create a deep copy of an array', () => {
        const arr = [1, 2, { a: 3 }];
        const copiedArr = (0, deepCopy_1023_1.deepCopy)(arr);
    ...
    (0, globals_1.test)('should create a deep copy of an object', () => {
        const obj = { a: 1, b: { c: 2 } };
        const copiedObj = (0, deepCopy_1023_1.deepCopy)(obj);
    ...
    (0, globals_1.test)('should handle nested objects and arrays', () => {
        ...
        const copiedComplexObj = (0, deepCopy_1023_1.deepCopy)(complexObj);
